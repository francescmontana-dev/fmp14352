...
gauges = (function () {
    'use strict';
// Force declare optional gauges to avoid ReferenceError when disabled
var gaugeUV = null;
var gaugeSolar = null;
var gaugeCloud = null;
var gaugeRose = null;
    ...
    var strings = LANG.EN,         // Set to your default language. Store all the strings in one object
        ...
        gaugeHum, gaugeBaro, gaugeWind, gaugeDir,F
        gaugeUV = null, gaugeSolar = null, gaugeCloud = null, gaugeRose = null,
...
getRealtime = function () {
    ...
    jqXHR = $.ajax({
        ...
        dataType : 'text',
        timeout  : config.longPoll
            ? (Math.min(config.realtimeInterval, 20) + 21) * 1000
            : 21000
}).done(function (data) {
